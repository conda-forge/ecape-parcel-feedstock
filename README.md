...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ecape-parcel-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ecape-parcel-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ecape-parcel
# for installing globally
pixi global install ecape-parcel
```
...
It is possible to list all of the versions of `ecape-parcel` available on your platform:
...
```
pixi search ecape-parcel --channel conda-forge
```
